shot_bin = read_float_binary("sig_sauer_308_distant");
shot = shot_bin(1:6000);
shot_lin = transpose(shot);
shot_match_filt = fliplr(shot_lin);
sens_input = read_float_binary("sig_sauer_308_distant_crowd_shot");
sens_out = conv(sens_input,shot_match_filt);
csvwrite("/home/ben/Desktop/senior_design/shot_taps/sig_sauer_308_distant_taps.txt",shot_match_filt)
figure(1)
...
plot(sens_out)
title("sensor output")
r = dlmread("/home/ben/Desktop/senior_design/shot_taps/sig_sauer_308_distant_taps.txt", ",");
size(r)
r(1:6)
figure(4)
plot(r)

...
%                                   v v
shot_bin = 250.*read_float_binary("audio_recordings/cbdshot2");
shot_lin = transpose(shot_bin);
size(shot_bin)
shot = shot_lin(2368500:2377000);
shot_match_filt = fliplr(shot);
%     rename taps file here |  |  |
%                           v  v  v       
csvwrite("/home/ben/Desktop/senior_design/field_test/taps/cbdshot2.txt",shot_match_filt)
shot(1:4)
shot_match_filt(1:4)
figure(1)
subplot(1,3,1)
